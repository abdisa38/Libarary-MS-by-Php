<?php
/**
 * Registration Page - AUTO LOGIN VERSION
 * Copy this file to: C:\xampp\htdocs\library-ms\auth\register.php
 */
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p>Register and get instant access</p>
            </div>
            ...
            <form method="POST" action="" class="auth-form">
                ...
                <button type="submit" class="btn btn-primary btn-block">Create Account & Login</button>
            </form>
